...
interface KRAAssignDialogProps {
  ...
  teamMembers: any[];
  onAssign: (templateId: string, selectedEmployees: string[], dueDate: string) => void;
  onCancel: () => void;
  isLoading?: boolean;
}

export function KRAAssignDialog({ template, teamMembers, onAssign, onCancel, isLoading = false }: KRAAssignDialogProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onAssign(template.id, selectedEmployees, dueDate);
  };
