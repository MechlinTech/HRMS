...
import { KRAManagerEvaluationForm } from './KRAManagerEvaluationForm';
...
export function KRAAssignmentManager({ assignments, isLoading, teamMembers = [], permissions }: KRAAssignmentManagerProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Manager Evaluation Dialog */}
      <Dialog open={isEvaluationDialogOpen} onOpenChange={setIsEvaluationDialogOpen}>
        <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              {selectedAssignment?.employee?.full_name} - {selectedAssignment?.template?.template_name}
            </DialogTitle>
            <DialogDescription>
