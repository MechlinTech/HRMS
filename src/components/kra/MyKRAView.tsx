...
import { KRAEmployeeForm } from './KRAEmployeeForm';
    ...
    <div className="space-y-6">
      ...
      <Dialog open={isFormDialogOpen} onOpenChange={setIsFormDialogOpen}>
        <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              {user?.full_name ? `${user.full_name}'s KRA Sheet` : selectedAssignment?.template?.template_name}
            </DialogTitle>
            <DialogDescription>
          ...
          {selectedAssignment && (
            <KRAEmployeeForm
              ...
              isReadOnly={!isEditable(selectedAssignment)}
              onClose={() => {
