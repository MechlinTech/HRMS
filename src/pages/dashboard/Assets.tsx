...
import { useUserAssets, useCreateAssetComplaint, useUserAssetComplaints, useAssetCategories, useCreateAssetRequest, useUserAssetRequests } from '@/hooks/useEmployees';
                      ...
                      {userAssets.map((assignment) => {
                        ...
                        return (
                          <TableRow key={assignment.id}>
                            ...
                            <TableCell>
                              <Badge className={getConditionBadge(assignment.asset.condition || 'good')}>
